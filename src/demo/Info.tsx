...
export function Info() {
  return (
    <HStack dimension={[300, Infinity]} margin={[16, 16, 16, 16]}>
      <Image dimension={[56, 56]} url={appState.get("url")} objectFit="cover" />
      <VStack weight={1} margin={[12, 16, 12, 16]}>
        <Text
          textAlign="start"
          weight={1}
          dimension={[Infinity, 12]}
          fontSize={12}
          fontWeight={600}
          color={[255, 255, 255, 1]}
        >
        ...
        <Text
          ...
          weight={1}
          fontWeight={300}
          dimension={[Infinity, 11]}
          fontSize={10}
          color={[255, 255, 255, 1]}
        >
          {appState.get("description").$((v) => v.slice(0, 20))}
        </Text>
      </VStack>
      <Path
        dimension={[16, 16]}
