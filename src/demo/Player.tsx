...
function ProgreeBar() {
  return (
    <HStack weight={0} dimension={[Infinity, 36]} margin={[8, -1, 16, -1]}>
      <Text
        color={[106, 106, 106, 1]}
        margin={[-1, -1, -1, -1]}
        dimension={[20, 10]}
...
function Progress() {
  return (
    <VStack weight={1} dimension={[380, Infinity]} margin={[0, -1, 0, -1]}>
      <Buttons />
      <ProgreeBar />
    </VStack>
  );
...
function Buttons() {
  return (
    <HStack weight={1} margin={[16, 80, 8, 80]}>
      <Icon
        paths={[
          {
            width: 16,
